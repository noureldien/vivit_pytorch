"""
Code borrowed from
https://github.com/TwentyBN/smth-smth-v2-baseline-with-models/blob/master/data_parser.py
"""
...
class DatasetBase(object):
    ...
    def __init__(self, json_path_input, json_path_labels, data_root, extension, is_test=False):
        ...
        if not self.is_test:
            ...
            with open(self.json_path_input, 'rb') as jsonfile:
                ...
                for elem in json_reader:
                    ...
                    item = ListData(elem['id'], "Holding something", os.path.join(self.data_root, elem['id'] + self.extension))
                    json_data.append(item)
        return json_data
...
class Mp4Dataset(DatasetBase):
    def __init__(self, json_path_input, json_path_labels, data_root, is_test=False):
        EXTENSION = ".mp4"
        super().__init__(json_path_input, json_path_labels, data_root, EXTENSION, is_test)
